...
<template>
  <div v-if="terms.length">
    <div class="cursor-pointer flex font-semibold mt-8 leading-none justify-between items-center text-white" @click="isOpen = !isOpen">
      <span>{{ label || $t('shop.category', 2) }}</span>
