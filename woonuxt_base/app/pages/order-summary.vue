...
<template>
  <div
    class="order-receipt-container w-full min-h-150 flex items-center p-4 bg-white text-gray-800 md:rounded-xl md:mx-auto md:shadow-lg md:my-24 md:mt-8 md:max-w-3xl md:p-16 flex-col">
