...
<template>
  <div class="relative group">
    ...
    <div class="p-2">
     <StarRating v-if="false" :rating="node.averageRating ?? undefined" :count="node.reviewCount ?? undefined" />      <NuxtLink v-if="node.slug" :to="productLink" :title="node.name || undefined">
